...
@Component({
  selector: 'app-workpro-mgmt',
  templateUrl: './workpro-mgmt.component.html',
  styleUrls: ['./workpro-mgmt.component.scss']
})
export class WorkproMgmtComponent implements AfterViewInit {
  markers
  lines
  progress:number = 25
